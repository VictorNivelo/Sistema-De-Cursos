 ...
 * @author Victor
 */
public class DialogoAgregarAlumno extends javax.swing.JFrame {

    /**
     * Creates new form DialogoAgregarAlumno
     */
    public DialogoAgregarAlumno() {
        initComponents();
    ...
    private void btnRegresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegresarActionPerformed
        ...
        DialogoAdmAlumno abrir = new DialogoAdmAlumno();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogoAgregarAlumno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DialogoAgregarAlumno().setVisible(true);
            }
        });
    }
